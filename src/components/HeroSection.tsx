...
const HeroSection = () => {
    return (
        <section className="mt-4 grid grid-cols-1 sm:grid-cols-12">
            <motion.div
            ...
            >
                <h1 className="mb-4 lg:text-6xl max-sm:text-[32px] sm:text-3xl leading-10 md:text-4xl font-extrabold">
                ...
                <p className="text-[#ADB7BE] text-[14px] sm:text-lg mb-6 lg:text-xl">
                    Мне 24 года, проживаю в Москве, занимаюсь программированием
                    с 2021 года.
                </p>
            ...
            >
                <Image
                    className="hidden sm:block shadow-sm shadow-violet-900"
                    src={"/images/me.jpg"}
                    width={320}
                    height={280}
                    priority
